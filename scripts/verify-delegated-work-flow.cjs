...
async function main() {
  ...
  try {
    ...
    for (const required of ['AI 계획 제안', '업무 위험도', '완료 조건', '결정 예상', '왜 이 팀인가요?', '실행하면 이렇게 진행됩니다', '예상 개입', '안전장치', '예상 결과물', '기본 계획 모드', 'AI 엔진 설정 전이라 기본 계획으로 preview를 생성했습니다.', '업무 검토 회의', '이 계획으로 AI 회사에 맡기기']) {
